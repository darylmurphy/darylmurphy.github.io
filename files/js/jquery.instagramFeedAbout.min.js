(function(a) {
    ...
    a.instagramFeed = function(e) {
        ...
        if ("" == f.username && "" == f.tag)
            ...
            !1;
        if ("undefined" != typeof f.get_raw_json && console.warn("Instagram Feed: get_raw_json is deprecated. Leave options.container undefined instead of setting options.get_raw_json to true"),
        "undefined" != typeof f.get_data && console.warn("Instagram Feed: options.get_data is deprecated. Leave options.container undefined instead of setting options.get_data to true"),
        null == f.callback && "" == f.container)
            return console.error("Instagram Feed: Error, neither container found nor callback defined."),
            !1;
        var g = "" == f.username
        ...
        return a.get(h, function(c) {
            ...
            "undefined" == typeof c)
                return void console.error("Instagram Feed: It looks like YOUR network has been temporary banned because of too many requests. See https://github.com/jsanahuja/jquery.instagramFeed/issues/25");
            ...
            "" != f.container) {
                ...
                if (f.display_gallery)
                    if ("undefined" != typeof c.is_private && !0 === c.is_private)
                        ...
                        j += "<div id='sync1' class='owl-carousel owl-theme'>";
                        for (var m = 0; m < s; m++) {
                            ...
                            j += "<div class='item'><a class='animation-container instagram-" + o + "'target='_blank' href='" + q + "' rel='noopener' target='_blank'><img class='instagram-img'" + (f.lazy_load ? " loading='lazy'" : "") + " src='" + n + "' alt='" + b(p) + "'" + e.gallery_image + "/></a><div class=\"insta-overlay\"><div class=\"img-info\"><div class='likes'><img src=\"../files/img/icons/heart.svg\" class=\"icon-sml\"/><p>" + l[m].node.edge_liked_by.count + "</p></div><p>" + b(p) + "</p></div></div></div>"
                        }
                        j += "</div>"
                    }

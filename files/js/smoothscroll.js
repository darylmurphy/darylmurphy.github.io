...
!(function(e, t) {
    ...
    var L = {
      ...
      , x = function(e) {
        return e ? (t = e,
        parseInt(C.getComputedStyle(t).height, 10) + e.offsetTop) : 0;
        var t
    }
      , Q = function(e, t, n, o) {
    ...
    return function(o, e) {
        ...
        w.animateScroll = function(i, s, e) {
            ...
            if (u || t) {
                ...
                )(t, p, parseInt("function" == typeof c.offset ? c.offset(i, s) : c.offset, 10), c.clip), y = g - l, S = q(), v = 0, E = (n = y,
                ...
                o.durationMax && a > o.durationMax ? o.durationMax : o.durationMin && a < o.durationMin ? o.durationMin : parseInt(a, 10)), b = function(e, t) {
                    ...
                    if (e == t || r == t || (l < t && C.innerHeight + r) >= S)
                    ...
                    b(f, g) || (A = C.requestAnimationFrame(O),
                    d = e)
                };
        ...
        ;
        var t = function(e) {
            if (!("matchMedia"in C && C.matchMedia("(prefers-reduced-motion)").matches) && 0 === e.button && !e.metaKey && !e.ctrlKey && "closest"in e.target && (a = e.target.closest(o)) && "a" === a.tagName.toLowerCase() && !e.target.closest(I.ignore) && a.hostname === C.location.hostname && a.pathname === C.location.pathname && /#/.test(a.href)) {
                var t = r(a.hash)
                  , n = I.topOnEmptyHash && "#" === t ? document.documentElement : document.querySelector(t);
          ...
          , n = function(e) {
            if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(I)) {
                ...
                t && 0 !== t && !(t = document.querySelector(r(history.state.anchor))) || w.animateScroll(t, null, {
                    updateURL: !1
                })
            }
        };
